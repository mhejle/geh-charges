...
namespace GreenEnergyHub.Charges.Infrastructure.Mapping
{
    public static class ChangeOfChargesMapper
    {
        ...
        public static ChangeOfChargesTransaction MapChargeToChangeOfChargesTransaction([NotNull] Charge charge)
        {
            return new ChangeOfChargesTransaction
            {
                ...
                MktActivityRecord = new MktActivityRecord
                {
                    ...
                    ValidityEndDate = charge.EndDate != null
                        ? Instant.FromUnixTimeTicks(charge.EndDate.Value)
                        : null as Instant?,
                },
